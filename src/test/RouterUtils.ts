...
export class RouterUtils extends ServicesUtils {
    ...
    /**
     * Fetch the specified Group via an API call, as the specified User
     *
     * @param name                      Group name to look up
     * @param asUsername                Username to perform lookup (superuser)
     */
    public async fetchGroup(name: string,
                              asUsername = SeedData.USER_USERNAME_SUPERUSER): Promise<Group> {
